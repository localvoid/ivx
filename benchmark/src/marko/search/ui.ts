...
const FOOTER = footer("gh-w").a({ id: "glbfooter", role: "contentinfo" }).c(
  div().c(
    div().a({ id: "rtm_html_1650" }).c([
      div().a({ id: "rtm_html_1651" }),
      h2("gh-ar-hdn").c("Additional site navigation"),
      div("gffoot").a({ id: "gf-BIG" }).c(
        table("gf-t").c(
          tbody().c(
            tr().c([
              td().c(
                  ...
                  li("gf-li").c(
                    div("gf-flags-wpr").c([
                      a("thrd").a({
                        ...
                        b("gf-if gspr flus"),
                        " ",
                        b("gh-sprRetina").a({ id: "gf-fbtn-arr" }),
                      ]),
                      div().a({ id: "gf-f" }).c(
                        ul("gf-ful").a({ role: "navigation" }).c([
                          li("gf-f-li0").c(
                            a("gf-if-a").a({
  ...
  return div("search-results-item").c([
    ...
    div("lvpic pic img left").c(
      div("lvpicinner full-width picW").c(
        a("img imgWr2").a({ href: `/buy/${item.id}` }).c(
          img().a({ src: item.image, alt: item.title }),
        ),
      ),
    ),
    span("price").c(item.price),
    button("buy-now").a(BUY_NOW_ATTRS).c("Buy now!"),
  ]);
});
